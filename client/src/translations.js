...
export const translations = {
  en: {
    ...
    promptShowBuyers: "Show wheat buyers & rates",
    promptSellToBuyer: "Sell 3Q wheat to ITC Limited",
  ...
  hi: {
    ...
    promptShowBuyers: "गेहूं के खरीदार और भाव दिखाओ",
    promptSellToBuyer: "आईटीसी को 3 क्विंटल गेहूं बेच दो",
  ...
  pa: {
    ...
    promptShowBuyers: "ਕਣਕ ਦੇ ਖਰੀਦਦਾਰ ਅਤੇ ਭਾਅ ਦਿਖਾਓ",
    promptSellToBuyer: "ਆਈਟੀਸੀ ਨੂੰ 3 ਕੁਇੰਟਲ ਕਣਕ ਵੇਚ ਦਿਓ",
